...
> **Estado FIXEAR:** cerrados #5, #6, #7, #8, #1, #2, #4. Quedan **#9 (separar ventas/cotizaciones), #10 (separar bobinas), #3 (negativos → "rindió de más", AL FINAL — hay trampa de corrupción de datos real detrás)**.
