...
exports.buildVoidXml = buildVoidXml;
const xmlbuilder2_1 = require("xmlbuilder2");
/**
 * Genera el XML de Comunicación de Baja (VoidedDocuments)
 */
function buildVoidXml(bajaInfo, sunatConfig) {
    ...
    const [serieOriginal, numeroOriginal] = bajaInfo.originalDocumentId.split("-");
    const xmlObj = {
        VoidedDocuments: {
...
//# sourceMappingURL=xmlVoidGenerator.js.map