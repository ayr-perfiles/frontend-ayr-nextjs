...
function FinishBadge({
  ...
  if (!finishId) {
    return (
      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-amber-50 text-amber-600 border border-amber-200 text-[10px] font-black">
        <AlertTriangle size={10} /> SIN ACABADO
      </span>
    );
  }
            ...
            {displayCoils.map((coil, index) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="p-4">
                    <FinishBadge finishId={coil.finish} finishes={finishes} />
                  </td>
